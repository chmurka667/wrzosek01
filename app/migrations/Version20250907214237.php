 ...
 */
final class Version20250907214237 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE url (id INT AUTO_INCREMENT NOT NULL, users_id INT NOT NULL, original_url VARCHAR(255) NOT NULL, shortened_url VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', email VARCHAR(255) NOT NULL, clicks INT NOT NULL, ip_address VARCHAR(45) DEFAULT NULL, blocked_until DATETIME DEFAULT NULL, INDEX IDX_F47645AE67B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE url ADD CONSTRAINT FK_F47645AE67B3B43D FOREIGN KEY (users_id) REFERENCES users (id) ON DELETE CASCADE');
