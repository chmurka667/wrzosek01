 ...
 */
final class Version20240912012104 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE url (id INT AUTO_INCREMENT NOT NULL, users_id INT DEFAULT NULL, original_url VARCHAR(255) NOT NULL, shortened_url VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, email VARCHAR(255) NOT NULL, clicks INT NOT NULL, INDEX IDX_F47645AE67B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
